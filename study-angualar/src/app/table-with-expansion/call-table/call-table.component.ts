...
@Input() columnsToDisplayWithExpand :any[]= [...this.columnsToDisplay, 'expand'];
  expandedElement: PeriodicElement | null | undefined;


  @ContentChild("expandedRowData", { static: false })
  wfExpandTemplateRef: TemplateRef<any> | undefined
